                    ...
                    return (
                        <div
                            ...
                            <div className="col-span-1 md:col-span-3">
                                ...
                                <p className="mb-2"><strong>Check in
                                    date:</strong> {format(new Date(reservation.start_date), 'yyyy-MM-dd')}</p>
                                <p className="mb-2"><strong>Check out
                                    date:</strong> {format(new Date(reservation.end_date), 'yyyy-MM-dd')}</p>

                                <p className="mb-2"><strong>Number of nights:</strong> {reservation.number_of_nights}
                                </p>
